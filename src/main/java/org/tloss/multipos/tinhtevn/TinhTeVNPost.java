package org.tloss.multipos.tinhtevn;
...
public class TinhTeVNPost implements PostArticle {
	...
	public String getUrl(int type, Object[] options) {
		...
		case PostArticle.LOGIN_FORM_URL:
			url = "http://www.tinhte.vn/forum/";
			break;
		case PostArticle.LOGIN_POST_URL:
			url = "http://www.tinhte.vn/login.php?do=login";
			break;
	...
	public boolean login(String username, String password,
		...
		if (securitytoken != null) {
			...
			if (responseBody != null
					&& responseBody.indexOf("Cảm ơn bạn đã đăng nhập.") > 0) {
	...
	public static void main(String[] args) throws Exception {
		...
		TinhTeVNPost article = new TinhTeVNPost();
		...
		XHTTGetArticle getArticle =  new XHTTGetArticle();
	 	Article article2 =  getArticle.get("http://xahoithongtin.com.vn/2011061508031456p0c252/filerfrog-thanh-phan-mo-rong-tuyet-voi-cho-windows-explorer.htm");
	 	article2.setContent(article2.getContent()+"Nguồn XHTT ");
		article.post(article2, article.getUrl(PostArticle.POST_FORM_URL, new Object[]{"57"}),
