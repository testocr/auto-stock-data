package org.tloss.multipos.haiphongit;
...
public class HaiPhongITPost implements PostArticle {
	...
	public String getUrl(int type, Object[] options) {
		...
		case PostArticle.LOGIN_FORM_URL:
			url = "http://haiphongit.com/forum/index.php";
			break;
		case PostArticle.LOGIN_POST_URL:
			url = "http://haiphongit.com/forum/login.php?do=login";
			break;
	...
	public String[] md5hash(String password) throws ScriptException,
		...
		jsEngine.eval(new InputStreamReader(HaiPhongITPost.class
				.getResourceAsStream("vbullentin_md5_v384.js")));
	...
	public boolean login(String username, String password,
		...
		if (securitytoken != null) {
			...
			if (responseBody != null
					&& responseBody.indexOf("<strong>Cám ơn, <strong>"
							+ username
							+ "</strong> đã đăng nhập thành công</strong>") > 0) {
				result = true;
				HttpGet htttGet = new HttpGet(getUrl(LOGIN_FORM_URL, null));
				setHeader(htttGet);
	...
	public static void main(String[] args) throws Exception {
		...
		HaiPhongITPost article = new HaiPhongITPost();
		System.out.println(article.login("tungt84", "", true, new Object[] {
				"59f255f323a7d3827171304187a87e6a",
				"59f255f323a7d3827171304187a87e6a" }));
		Article article2 = new Article();
		article.post(article2,
