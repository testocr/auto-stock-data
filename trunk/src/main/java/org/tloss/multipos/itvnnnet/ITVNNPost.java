package org.tloss.multipos.itvnnnet;
...
public class ITVNNPost implements PostArticle {
	...
	public String getUrl(int type, Object[] options) {
		...
		case PostArticle.LOGIN_POST_URL:
			url = "http://itvnn.net/login.php?do=login";
			break;
		case PostArticle.POST_FORM_URL:
			if (options != null && options.length > 0) {
				url = "http://itvnn.net/newthread.php?do=newthread&f="
		...
		case PostArticle.POST_URL:
			if (options != null && options.length > 0) {
				url = "http://itvnn.net/newthread.php?do=postthread&f="
						+ options[0];
			}
			break;
		}
	...
	public String[] md5hash(String password) throws ScriptException,
		...
		jsEngine.eval(new InputStreamReader(ITVNNPost.class
	...
	public static void main(String[] args) throws Exception {
		...
		//		new Object[] { "76" }), article.getUrl(PostArticle.POST_URL,
		//		new Object[] { "76" }), null);
