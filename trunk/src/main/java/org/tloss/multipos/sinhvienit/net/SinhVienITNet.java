package org.tloss.multipos.sinhvienit.net;
...
public class SinhVienITNet  implements PostArticle {
	...
	public String getUrl(int type, Object[] options) {
		...
		case PostArticle.LOGIN_FORM_URL:
			url = "http://sinhvienit.net/@forum/";
			break;
		case PostArticle.LOGIN_POST_URL:
			url = "http://sinhvienit.net/@forum/login.php?do=login";
			break;
		case PostArticle.POST_FORM_URL:
			if (options != null && options.length > 0) {
				url = "http://sinhvienit.net/@forum/newthread.php?do=newthread&f="
		...
		case PostArticle.POST_URL:
			if (options != null && options.length > 0) {
				url = "http://sinhvienit.net/@forum/newthread.php?do=postthread&f="
						+ options[0];
			}
			break;
		}
	...
	public String[] md5hash(String password) throws ScriptException,
		...
		jsEngine.eval(new InputStreamReader(SinhVienITNet.class
	...
	public static void main(String[] args) throws Exception {
		...
		SinhVienITNet article = new SinhVienITNet();
		...
		article.post(article2, article.getUrl(PostArticle.POST_FORM_URL,
				new Object[] { "223" }), article.getUrl(PostArticle.POST_URL,
				new Object[] { "223" }), null);
