package org.tloss.multipos.sinhvienvanlang.com;
...
public class SinhVienVanLangPost   implements PostArticle {
	...
	public String getUrl(int type, Object[] options) {
		...
		case PostArticle.LOGIN_FORM_URL:
			url = "http://sinhvienvanlang.com/@rum/";
			break;
		case PostArticle.LOGIN_POST_URL:
			url = "http://sinhvienvanlang.com/@rum/login.php?do=login";
			break;
		case PostArticle.POST_FORM_URL:
			if (options != null && options.length > 0) {
				url = "http://sinhvienvanlang.com/@rum/newthread.php?do=newthread&f="
		...
		case PostArticle.POST_URL:
			if (options != null && options.length > 0) {
				url = "http://sinhvienvanlang.com/@rum/newthread.php?do=postthread&f="
						+ options[0];
			}
			break;
		}
	...
	public String[] md5hash(String password) throws ScriptException,
		...
		jsEngine.eval(new InputStreamReader(SinhVienVanLangPost.class
	...
	public boolean login(String username, String password,
		...
		if (securitytoken != null) {
			...
			nvps.add(new BasicNameValuePair("vb_login_password_hint",
					"Mật khẩu"));
	...
	public static void main(String[] args) throws Exception {
		...
		SinhVienVanLangPost article = new SinhVienVanLangPost();
		article.login("tungt84", null, true, new Object[] {
				"59f255f323a7d3827171304187a87e6a",
				"59f255f323a7d3827171304187a87e6a" });
		// 223 -Software Area -System Tools
		...
		article.post(article2, article.getUrl(PostArticle.POST_FORM_URL,
				new Object[] { "228" }), article.getUrl(PostArticle.POST_URL,
				new Object[] { "228" }), null);
